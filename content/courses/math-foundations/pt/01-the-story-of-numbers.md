---
title: "A História dos Números"
description: "Descubra como civilizações antigas criaram sistemas numéricos e como essas invenções moldaram a matemática moderna."
order: 1
duration: "50 minutes"
difficulty: "beginner"
---
...
```matching
{
  "question": "Associe cada sistema numérico com sua base:",
  "pairs": [
    {"left": "Decimal", "right": "Base-10"},
    {"left": "Binário", "right": "Base-2"},
    {"left": "Sexagesimal", "right": "Base-60"},
    {"left": "Vigesimal", "right": "Base-20"},
...
$$
42_{10} = 1 \times 2^5 + 0 \times 2^4 + 1 \times 2^3 + 0 \times 2^2 + 1 \times 2^1 + 0 \times 2^0 = 101010_2
$$
...
$$
42_{10} = 2 \times 60^0 + 42_{60} = \text{IIC}_{60}
$$
...
$$
\text{Cor} = R \times 2^{16} + G \times 2^8 + B
$$
...
```question
{
  "id": "math-foundations-q1",
  "type": "multiple-choice",
  "question": "Qual civilização desenvolveu o sistema sexagesimal (base-60) que ainda usamos para medir tempo?",
  "options": [
    "Egípcios",
    "Gregos",
    "Sumérios/Babilônios",
  ...
  "correct": 2,
  "explanation": "Os sumérios, e depois os babilônios, desenvolveram o sistema sexagesimal por volta de 3000 a.C. Ainda usamos 60 segundos por minuto e 60 minutos por hora."
}
```

```question
{
  "id": "math-foundations-q2",
  "type": "multiple-choice",
  "question": "Qual é a principal vantagem do sistema de valor posicional?",
  "options": [
    "Usa mais símbolos",
    "É mais difícil de aprender",
    "Reduz o número de símbolos necessários",
...
```question
{
  "id": "math-foundations-q3",
  "type": "multiple-choice",
  "question": "Qual número é o resultado da conversão de 42 (decimal) para binário?",
  "options": [
    "101010",
    "110010",
    "100110",
  ...
  "correct": 0,
  "explanation": "42 = 32 + 8 + 2 = 2⁵ + 2³ + 2¹ = 101010 em binário."
}
```

```question
{
  "id": "math-foundations-q4",
  "type": "multiple-choice",
  "question": "Por que os computadores usam binário em vez de decimal?",
  "options": [
    "Porque é mais fácil para humanos",
    "Porque circuitos eletrônicos têm dois estados estáveis",
    "Porque binário é mais rápido que decimal",
    "Porque os programadores preferem"
  ],
  "correct": 1,
...
```question
{
  "id": "math-foundations-q5",
  "type": "multiple-choice",
  "question": "Qual civilização desenvolveu independentemente o conceito de zero como placeholder?",
  "options": [
    "Egípcios",
    "Gregos",
    "Maias",
  ...
  "correct": 2,
  "explanation": "Os maias desenvolveram o conceito de zero independentemente, séculos antes de ser amplamente adotado no Velho Mundo."
}
```

```question
{
  "id": "math-foundations-q6",
  "type": "multiple-choice",
  "question": "Qual é o valor do número binário 1101 em decimal?",
  "options": [
    "11",
    "13",
    "15",
...
```question
{
  "id": "math-foundations-q7",
  "type": "multiple-choice",
  "question": "Qual é a base do sistema numérico que usamos no dia a dia?",
  "options": [
    "Base-2 (binário)",
    "Base-8 (octal)",
    "Base-10 (decimal)",
  ...
  "correct": 2,
  "explanation": "O sistema decimal (base-10) é o mais universalmente usado, provavelmente porque temos 10 dedos nas mãos."
}
```
