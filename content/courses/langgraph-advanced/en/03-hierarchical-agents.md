...
description: "Implement hierarchical multi-agent architectures with manager agents, sub-agents, subgraphs, and state passing between hierarchy levels."
order: 3
duration: "40 minutes"
difficulty: "advanced"
---
...
3. **Encapsulation**: Agent internals leak into the shared state
...
Subgraphs are graphs used as nodes within a parent graph. They have their own state, nodes, and edges — fully encapsulated.
...
[!IMPORTANT]
Subgraphs at any level can contain their own subgraphs. This nesting enables arbitrarily complex agent hierarchies while maintaining encapsulation at each level.
...
## Complete Hierarchical Agent Example
