---
title: "Otimização"
description: "Otimize aplicações LangGraph — reduza chamadas de nós, estratégias de cache, lotação de requisições LLM, gerenciamento de tokens e ajuste de desempenho do grafo."
order: 9
duration: "35 minutes"
difficulty: "advanced"
---
...
## Onde a Otimização é Importante

| Area | Impacto | Otimização |
| :--- | :--- | :--- |
| LLM calls | Custo + latency | Caching, batching, model selection |
...
| Paralelismo | Throughput | Smart fan-out, avoid contention |

---

## Cache de Chamadas LLM
...
### Contagem de Tokens em Streaming
...
## Reduzindo Nós Desnecessários

### Mesclar Nós de Transformação Triviais
...
| Estratégia | Esforço | Impacto |
| :--- | :--- | :--- |
| LLM response caching | Low | High (repeated queries) |
| Modol selection per node | Low | High (cost) |
