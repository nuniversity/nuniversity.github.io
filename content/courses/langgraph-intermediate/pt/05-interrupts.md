---
title: "Humano-no-circuito com Interrupções"
description: "Implemente fluxos de trabalho humano-no-circuito usando interrupções, pause a execução para entrada do usuário e retome a execução do grafo."
order: 5
duration: "35 minutes"
difficulty: "intermediate"
---

# Humano-no-circuito com Interrupções
...
## Executando o Grafo com Interrupções
...
## Múltiplos Pontos de Interrupção
...
## Mensagens de Interrupção Dinâmicas
...
## Exemplo Completo: Moderação de Conteúdo
