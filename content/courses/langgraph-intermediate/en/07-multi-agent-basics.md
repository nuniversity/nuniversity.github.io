...
description: "Learn multi-agent architecture in LangGraph — multiple agent nodes communicating through shared state, specialized agent roles, and coordination patterns."
order: 7
duration: "40 minutes"
